{
 "cells": [
  {
   ...
   "metadata": {
    "papermill": {
     "duration": 0.003337,
     "end_time": "2026-02-12T18:21:14.365021",
     "exception": false,
     "start_time": "2026-02-12T18:21:14.361684",
     "status": "completed"
    },
    "tags": []
   },
  ...
  },
  {
   ...
   "metadata": {
    ...
    "collapsed": false,
    "execution": {
     "iopub.execute_input": "2026-02-12T18:21:14.373283Z",
     "iopub.status.busy": "2026-02-12T18:21:14.372918Z",
     "iopub.status.idle": "2026-02-12T18:21:43.474662Z",
     "shell.execute_reply": "2026-02-12T18:21:43.473214Z"
    },
    "jupyter": {
    ...
    "papermill": {
     "duration": 29.110157,
     "end_time": "2026-02-12T18:21:43.477473",
     "exception": false,
     "start_time": "2026-02-12T18:21:14.367316",
     "status": "completed"
    },
    "tags": []
   },
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "2026-02-12 18:21:16.652326: E external/local_xla/xla/stream_executor/cuda/cuda_fft.cc:467] Unable to register cuFFT factory: Attempting to register factory for plugin cuFFT when one has already been registered\n",
      "WARNING: All log messages before absl::InitializeLog() is called are written to STDERR\n",
      "E0000 00:00:1770920476.889738      17 cuda_dnn.cc:8579] Unable to register cuDNN factory: Attempting to register factory for plugin cuDNN when one has already been registered\n",
      "E0000 00:00:1770920476.959216      17 cuda_blas.cc:1407] Unable to register cuBLAS factory: Attempting to register factory for plugin cuBLAS when one has already been registered\n",
      "W0000 00:00:1770920477.530521      17 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.\n",
      "W0000 00:00:1770920477.530578      17 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.\n",
      "W0000 00:00:1770920477.530582      17 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.\n",
      "W0000 00:00:1770920477.530586      17 computation_placer.cc:177] computation placer already registered. Please check linkage and avoid linking the same target more than once.\n"
     ]
    },
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "⏱️  simulate_wave_collapse_metriplectic ejecutado en 0.0884s\n",
      ...
      "--------------------------------------------------------------------------------\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0313s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0044s\n"
     ]
    },
    {
     "name": "stderr",
     "output_type": "stream",
     "text": [
      "2026-02-12 18:21:42.392401: E external/local_xla/xla/stream_executor/cuda/cuda_platform.cc:51] failed call to cuInit: INTERNAL: CUDA error: Failed call to cuInit: UNKNOWN ERROR (303)\n"
     ]
    },
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0047s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      ...
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0046s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0056s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0062s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0048s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0046s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0046s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      ...
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0050s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0043s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0048s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0046s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      ...
      "⏱️  objective_function_with_noise ejecutado en 0.0042s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0044s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0049s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0042s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0042s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0046s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0042s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0051s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0042s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0042s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      ...
      "⏱️  objective_function_with_noise ejecutado en 0.0043s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0057s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0042s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0055s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0053s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      ...
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0052s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0046s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0041s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0039s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0043s\n",
      ...
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0040s\n",
      "⏱️  optimize_quantum_state ejecutado en 0.9973s\n",
      "⏱️  objective_function_with_noise ejecutado en 0.0045s\n",
      ...
      "⏱️  calculate_probabilities_and_select_action ejecutado en 0.0001s\n",
      "⏱️  simulate_wave_collapse_metriplectic ejecutado en 0.0032s\n",
      "\n",
      "  Ciclo 1:\n",
      ...
      "    - Acción: 1\n",
      "⏱️  calculate_probabilities_and_select_action ejecutado en 0.0001s\n",
      "⏱️  simulate_wave_collapse_metriplectic ejecutado en 0.0030s\n",
      "\n",
      "  Ciclo 2:\n",
      "    - von Neumann entropy: 0.5000\n",
      "    - Shannon (norm): 0.9583\n",
      ...
      "    - Acción: 1\n",
      "⏱️  calculate_probabilities_and_select_action ejecutado en 0.0000s\n",
      "⏱️  simulate_wave_collapse_metriplectic ejecutado en 0.0031s\n",
      "\n",
      "  Ciclo 5:\n",
      "    - von Neumann entropy: 0.5000\n",
      "    - Shannon (norm): 0.9584\n",
 ...
 "metadata": {
  ...
  "papermill": {
   "default_parameters": {},
   "duration": 35.567853,
   "end_time": "2026-02-12T18:21:46.376040",
   "environment_variables": {},
   "exception": null,
   "input_path": "__notebook__.ipynb",
   "output_path": "__notebook__.ipynb",
   "parameters": {},
   "start_time": "2026-02-12T18:21:10.808187",
   "version": "2.6.0"
  }
 },
 "nbformat": 4,
